...
//
// Marauder Mini
// ST7735 over Arduino_HWSPI, 128x128.
//
// Launcher envs: Awok-Mini, Marauder-Mini

#ifndef DISPLAY_DEVICE_MARAUDER_MINI_H
#define DISPLAY_DEVICE_MARAUDER_MINI_H
...
#define TFT_IPS 0
#define TFT_COL_OFS1 2
#define TFT_ROW_OFS1 3
...
#endif // DISPLAY_DEVICE_MARAUDER_MINI_H
