...
//
// Launcher envs: Awok-Touch, Marauder-v4-OG, Marauder-v61, WaveSentry-R1

#ifndef DISPLAY_DEVICE_MARAUDER_V4_V6_H
#define DISPLAY_DEVICE_MARAUDER_V4_V6_H
...
#endif // DISPLAY_DEVICE_MARAUDER_V4_V6_H
