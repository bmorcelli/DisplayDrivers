...
//
// Launcher env: lilygo-t-display-c5

#ifndef DISPLAY_DEVICE_LILYGO_T_DISPLAY_C5_H
#define DISPLAY_DEVICE_LILYGO_T_DISPLAY_C5_H
...
#endif // DISPLAY_DEVICE_LILYGO_T_DISPLAY_C5_H
