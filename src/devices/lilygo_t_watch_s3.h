...
//
// Lilygo T-Watch S3
// ST7789 over Arduino_HWSPI, 240x240.
//
// Launcher env: lilygo-t-watch-s3

#ifndef DISPLAY_DEVICE_LILYGO_T_WATCH_S3_H
#define DISPLAY_DEVICE_LILYGO_T_WATCH_S3_H
...
#endif // DISPLAY_DEVICE_LILYGO_T_WATCH_S3_H
