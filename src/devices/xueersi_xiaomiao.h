...
//
// Xueersi XiaoMiao
// ST7735 over Arduino_HWSPI, 128x160.
//
// Launcher env: xueersi-xiaomiao

#ifndef DISPLAY_DEVICE_XUEERSI_XIAOMIAO_H
#define DISPLAY_DEVICE_XUEERSI_XIAOMIAO_H
...
#endif // DISPLAY_DEVICE_XUEERSI_XIAOMIAO_H
