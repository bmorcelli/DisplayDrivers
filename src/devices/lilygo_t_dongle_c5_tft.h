...
//
// Launcher env: lilygo-t-dongle-c5-tft

#ifndef DISPLAY_DEVICE_LILYGO_T_DONGLE_C5_TFT_H
#define DISPLAY_DEVICE_LILYGO_T_DONGLE_C5_TFT_H
...
#endif // DISPLAY_DEVICE_LILYGO_T_DONGLE_C5_TFT_H
