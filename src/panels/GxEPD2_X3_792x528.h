...
//
// This covers the ORIGINAL X3 batch only. Newer units ship a UC8279d instead,
// which runs pure factory OTP waveforms and wants no LUT upload at all — the
// opposite of this driver. Which controller a unit carries is not knowable at
// build time; it is read from the controller's VER register (0x70) at boot.
//
